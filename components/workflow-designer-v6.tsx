...
import { EnhancedWorkflowCanvas } from "./workflow/enhanced-workflow-canvas"
...
interface WorkflowDesignerV6Props {
  onBack: () => void
}
...
export function WorkflowDesignerV6({ onBack }: WorkflowDesignerV6Props) {
