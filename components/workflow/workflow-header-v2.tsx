...
interface WorkflowHeaderV2Props {
  onBack: () => void
}

export function WorkflowHeaderV2({ onBack }: WorkflowHeaderV2Props) {
  return (
    <header className="flex h-14 items-center justify-between border-b border-border bg-card px-4">
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="ml-2 rounded bg-chart-3/20 px-1.5 py-0.5 text-[10px] font-medium text-chart-3">
            Quadrant
          </span>
        </div>
