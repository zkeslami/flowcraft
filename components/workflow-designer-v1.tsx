...
import { WorkflowHeaderV1 } from "./workflow/workflow-header-v1"
...
interface WorkflowDesignerV1Props {
  onBack: () => void
}

export function WorkflowDesignerV1({ onBack }: WorkflowDesignerV1Props) {
  ...
  const handleAddNode = useCallback(() => {
    ...
    // Add connection from selected to new node
  ...
  return (
    <div className="flex h-screen flex-col bg-background">
      <WorkflowHeaderV1 onBack={onBack} />
