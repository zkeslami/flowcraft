...
import { WorkflowHeaderV3 } from "./workflow/workflow-header-v3"
...
interface WorkflowDesignerV3Props {
  onBack: () => void
}

export function WorkflowDesignerV3({ onBack }: WorkflowDesignerV3Props) {
  ...
  const showCollapsedBar = isPanelCollapsed || (!isPanelExpanded && !selectedNode)

  return (
    <div className="flex h-screen flex-col bg-background">
      <WorkflowHeaderV3 onBack={onBack} />
